...
processor_dir = current_dir.parent / "processors" #stupid that this is needed to ensure we import the correct .json while running from a different directory
src_dir = current_dir.parent / "src"
sys.path.append(str(src_dir))

from analysis_tools.taggers.lep_tagger_v3 import tag_ele_quality, tag_lpte_quality, tag_muon_quality

from analysis_tools.taggers.gen_tagger import tag_gen_flags

from analysis_tools.taggers.lep_cuts import *

from analysis_tools.plotting.eff_plotting import get_1d_pt_hist_v2, get_2d_eta_pt_hist_v2
...
class Processor(processor.ProcessorABC):
    ...
    def process(self, events):
        ...
        with open(f'{processor_dir}/object_selections.json') as file:
        ...
        qual_categories = ["isGold", "isSilver", "isBronze", "isGoldSilver"]
        ...
        basic_func_call_loop(ele, get_1d_pt_hist_v2, "1d_pt_hist")
        basic_func_call_loop(ele, get_2d_eta_pt_hist_v2, "2d_pt_eta_hist")
