...
#don't use!! use the one without iso and without hoe
...
def veto_minus_iso_hoe_mask(ele_obj):
...
def tight_minus_iso_hoe_mask(ele_obj):
...
def veto_minus_iso_hoe_cut(ele_obj):

    return ele_obj[veto_minus_iso_hoe_mask(ele_obj)]


def tight_minus_iso_cut(ele_obj):

    return ele_obj[tight_minus_iso_mask(ele_obj)]


def tight_minus_iso_hoe_cut(ele_obj):

    return ele_obj[tight_minus_iso_hoe_mask(ele_obj)]
